  ...
  <div class="row">
    <div id="content"> 
      ...
      <div class="product-details">
        ...
        <div id="product">
          ...
          <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
            ...
            <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="create-accounttxtfield license-type">
              <?php if($option['name'] != 'License'){ ?>
          ...
          <?php if($option['name'] == 'License'){ ?>
          <?php foreach ($option['product_option_value'] as $option_value) { ?>
          <span id="license-price-<?php echo $option_value['product_option_value_id']; ?>" class="hidden"><?php echo $option_value['price']; ?></span>
          <?php } ?>
          <?php } ?>
          ...
          <div class="form-group">
            ...
            <br />
            <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="addtocart-btn"><?php echo $button_cart; ?></button>
          </div>
          <?php if ($minimum > 1) { ?>
      ...
      <div class="related-logos">
        ...
        <div class="col-xs-6 col-sm-3 col-md-3 logo-thumb-details">
          <div class="product-thumb transition">
            <div class="latest-logo-img image"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-9">
                <a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a> 
                <span><?php echo ($product['regular_license_price'] ? $product['regular_license_price'] : '---' ); ?></span>
              </div>
              <div class="col-xs-12 col-sm-9 col-md-3 buynow">
...
$(document).ready(function(){
	...
	license_type_value = $('.license-type').val();
	price = $('#license-price-'+license_type_value).text();
	$('#price').text(price);
	
	$('.license-type').change(function(){
		license_type_value = $(this).val();
		price = $('#license-price-'+license_type_value).text();
		$('#price').text(price);
	});
});
