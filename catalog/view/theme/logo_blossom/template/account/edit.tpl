        ...
        <fieldset>
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-email"><?php echo $entry_email; ?></label>
              <input type="email" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="create-accounttxtfield" />
              <?php if ($error_email) { ?>
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-telephone"><?php echo $entry_telephone; ?></label>
              <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="create-accounttxtfield" />
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <label for="input-fax"><?php echo $entry_fax; ?></label>
              <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="<?php echo $entry_fax; ?>" id="input-fax" class="create-accounttxtfield" />
          </div>
          <!--Below custom fields are hide.-->
          <?php /*?><?php foreach ($custom_fields as $custom_field) { ?>
