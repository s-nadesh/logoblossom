        ...
        <fieldset>
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-firstname"><?php echo $entry_firstname; ?></label>
              <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname" class="create-accounttxtfield" />
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-lastname"><?php echo $entry_lastname; ?></label>
              <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="create-accounttxtfield" />
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <label for="input-company"><?php echo $entry_company; ?></label>
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="create-accounttxtfield" />
          </div>
          
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-address-1"><?php echo $entry_address_1; ?></label>
              <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="create-accounttxtfield" />
          ...
          <div class="form-group col-xs-12 col-sm-12 col-md-12">
            <label for="input-address-2"><?php echo $entry_address_2; ?></label>
              <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="create-accounttxtfield" />
          </div>
          
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-city"><?php echo $entry_city; ?></label>
              <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="create-accounttxtfield" />
              <?php if ($error_city) { ?>
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-postcode"><?php echo $entry_postcode; ?></label>
              <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="create-accounttxtfield" />
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-country"><?php echo $entry_country; ?></label>
              <select name="country_id" id="input-country" class="create-accounttxtfield">
          ...
          <div class="form-group required col-xs-12 col-sm-12 col-md-12">
            <label for="input-zone"><?php echo $entry_zone; ?></label>
              <select name="zone_id" id="input-zone" class="create-accounttxtfield">
              </select>
              <?php if ($error_zone) { ?>
