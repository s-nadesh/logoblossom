...
<div class="header">
  <div class="header-row1">
    <div class="container">
      <div class="header-contact"> <span> <a href="<?php echo $contact; ?>"> 
        <img src="catalog/view/theme/logo_blossom/image/phone.png" width="16" height="14" alt=""></a> Call us : <?php echo $telephone; ?></span> <span><img src="catalog/view/theme/logo_blossom/image/mail.png" width="16" height="10" alt=""> Email : <?php echo $email; ?> </span> </div>
  ...
  <div class="header-row2">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 cart"> 
        <?php echo $cart; ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-md-8 slider-left">
        ...
        Ready-made logo design templates for $50
        <?php echo $search; ?>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
      <img src="catalog/view/theme/logo_blossom/image/logo-slider.png"  alt="">
      </div>
    </div>
  </div>
</div>
